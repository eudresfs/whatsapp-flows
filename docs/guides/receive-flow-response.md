...
Source: https://developers.facebook.com/docs/whatsapp/flows/guides/receiveflowresponse/
...
The structure of flow-specific data is controlled by Flow JSON or, in case you are using Endpoint for your flow, by final response payload from endpoint. See [Response Message Webhook](/documentation/business-messaging/whatsapp/flows/guides/receiveflowresponse) reference page for more details.
