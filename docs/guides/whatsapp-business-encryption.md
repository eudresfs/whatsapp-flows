...
Source: https://developers.facebook.com/docs/whatsapp/flows/guides/whatsapp-business-encryption
...
The phone number must be [successfully registered](/documentation/business-messaging/whatsapp/business-phone-numbers/registration#register), and the business must have [generated a 2048-bit RSA Key](#gen) as described below.
...
```curl
curl -X POST \
  'https://graph.facebook.com//PHONE_NUMBER_ID/whatsapp_business_encryption' \
...
Please see [Error and Status Messages](/documentation/business-messaging/whatsapp/support/error-codes) if you encounter any errors.

## Get Business Public Key

The phone number must be [successfully registered](/documentation/business-messaging/whatsapp/business-phone-numbers/registration#register), and the business must have [generated a 2048-bit RSA key](#gen).
