...
Source: https://developers.facebook.com/docs/whatsapp/flows/guides/interactive-flow-messages/

After you create a [WhatsApp Flow](/documentation/business-messaging/whatsapp/flows), you can send it. To send a message with a flow, we have introduced a new type of the Interactive Object called `flow`. These are the following properties of the Interactive Object specific to flows:
...
```curl
curl -X  POST \
 'https://graph.facebook.com//FROM_PHONE_NUMBER_ID/messages' \
