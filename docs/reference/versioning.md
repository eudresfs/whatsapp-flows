...
Version |  Type |  Format |  Example | **Flow JSON** | string | `{major}.{minor}` | `1.9`  
---|---|---|---  
...
Change |  Version Change | Add a new parameter | `1.0` -> `1.1`  
---|---  
...
Date |  Event | 1-Jan-2024 | Version `1.0` launches  
---|---  
...
Date |  Event | 1-Dec-2023 | Version `1.1` launches  
---|---  
...
[←PreviousError Codes](/web/20241111084522/https://developers.facebook.com/docs/whatsapp/flows/reference/error-codes)

[→NextResponse Message Webhook](/web/20241111084522/https://developers.facebook.com/docs/whatsapp/flows/reference/responsemsgwebhook)
