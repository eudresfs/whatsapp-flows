...
There are the following alternatives to edit a flow after publishing:
  ...
  * In case you need to change the flow significantly, please consider [creating a new Flow](/web/20250410214551/https://developers.facebook.com/docs/whatsapp/flows/reference/flowsapi#create) that clones the existing one \(using the `clone_flow_id` field\).
  * Since you cannot delete published flow, deprecate it instead using [the `/deprecate` API call](/web/20250410214551/https://developers.facebook.com/docs/whatsapp/flows/reference/flowsapi#deprecate).
...
State| Event| Action| New state| | Create a new Flow | [Create](/web/20250410214551/https://developers.facebook.com/docs/whatsapp/flows/reference/flowsapi#create) | Draft  
---|---|---|---  
Draft | Update the Flow JSON content | [Update JSON](/web/20250410214551/https://developers.facebook.com/docs/whatsapp/flows/reference/flowsapi#update-json) | Draft  
Draft | Update the `data_channel_uri` | [Update](/web/20250410214551/https://developers.facebook.com/docs/whatsapp/flows/reference/flowsapi#update) | Draft  
Draft | Decide that the Flow is ready for production | [Publish](/web/20250410214551/https://developers.facebook.com/docs/whatsapp/flows/reference/flowsapi#publish) | Published  
...
Draft | Update the Flow JSON content | [Update JSON](/web/20250410214551/https://developers.facebook.com/docs/whatsapp/flows/reference/flowsapi#update-json) | Draft  
Draft | Update the `data_channel_uri` | [Update](/web/20250410214551/https://developers.facebook.com/docs/whatsapp/flows/reference/flowsapi#update) | Draft  
Draft | Decide that the Flow isn't needed anymore | [Delete](/web/20250410214551/https://developers.facebook.com/docs/whatsapp/flows/reference/flowsapi#delete) | Deleted  
  
[←PreviousWhat are Flows?](/web/20250410214551/https://developers.facebook.com/docs/whatsapp/flows/introduction/whatarewaflows)

[→NextIntroduction to Flow JSON](/web/20250410214551/https://developers.facebook.com/docs/whatsapp/flows/introduction/introflowjson)
