...
Flow JSON Section |  Description | Screen Data Model | Commands to define static types that power the screen.  
---|---  
...
Component |  Masking |  Consumer experience | Text Input | ✅ | Masked input value \(`••••••••••••`\)  
---|---|---  
...
Operators |  Types allowed |  Return type | `==`, `!=` | strings, numbers and booleans   
both sides should have the same type \(validated during Flow JSON creation time\) | `boolean`  
---|---|---  
...
Operators |  Types allowed |  Return type | `<`, `<=`, `>`, `>=` | numbers | `boolean`  
---|---|---  
...
Operators |  Types allowed |  Return type | `&&`, `||` | booleans | `boolean`  
---|---|---  
...
Operators |  Types allowed |  Return type | No special sign is required, just add space between the expression members | strings, numbers and booleans | `string`  
---|---|---  
...
Operators |  Types allowed |  Return type | `+`, `-`, `/`, `%` | numbers | `number`  
---|---|---  
...
Component |  Can Be Used Outside Forms? \(Before Flow JSON 4.0\) |  Can Be Used Outside Forms? \(Flow JSON 4.0+\) | Text \(TextHeading, TextSubheading, TextCaption, TextBody\) | ✅ | ✅  
---|---|---  
TextInput | ❌ | ✅  
TextArea | ❌ | ✅  
CheckboxGroup | ❌ | ✅  
...
Attribute |  Description | `init-values`| <key, value> object where key - Field Name in Component value - Field Initial Value type - String, Array< String > or Dynamic `init-values`="$\{data.init\_values\}"  
---|---  
...
Component | `init-values` data type | CheckboxGroup | Array of Strings  
---|---  
...
Flow JSON Reference |  Description |  Payload Type | `data_exchange` | Sending Data to WhatsApp Flows Data Endpoint | Customizable JSON payload on data exchanges \{ \[key:string\]: any \}  
---|---|---  
...
A comprehensive list of validation errors is available [here](/web/20250201223605/https://developers.facebook.com/docs/whatsapp/flows/reference/error-codes#static-validation-errors).
